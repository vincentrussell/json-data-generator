...
```
java -jar json-data-generator-1.11-standalone.jar -s source.json -d destination.json
```
### Options
...
```
java -cp json-data-generator-1.11-standalone.jar:yourfunctions.jar com.github.vincentrussell.json.datagenerator.CLIMain -s source.json -d destination.json -f my.package.NewFunction
```
